// store/home-page-store-types.ts
import { HomePageData, HomePageContent, HeroSection, Banner, WhyUsSection, Testimonial, AboutUsSection, ContactUsSection, Feature, Stat, ContactFormField, TestimonialsSection } from '@/types/home-page';
...
export interface HomePageStore {
  ...
  updateHeroButton: (type: 'primary' | 'secondary', updates: Partial<HeroSection['primaryButton']>, lang?: 'en' | 'ar') => void;
  ...
  updateContactFormField: (index: number, updates: Partial<ContactFormField>, lang?: 'en' | 'ar') => void;
